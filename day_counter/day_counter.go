...
func main() {
	...
	fmt.Println("Сегодня 2 августа 2025 года мы начинаем новый большой раздел 'Основы HTTP'")
	fmt.Println("Сегодняшняя тема: 'Слушаем сетевое соединение. Слушаем TCP-сокет с использованием пакета net.'")
}
